...
We as members, contributors, and maintainers of **AsiBackbone** pledge to make
...
* Focusing on what is best not just for us as individuals, but for the overall
  community and the long-term health of the AsiBackbone project
...
repository, issue tracker, pull requests, discussion forums, mailing lists, and
any official community chat channels — and also applies when an individual is
officially representing AsiBackbone in public spaces (e.g., conferences, social
media, or blog posts published under the project banner).
